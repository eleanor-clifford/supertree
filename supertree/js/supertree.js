...
function s(e, s, a = "Data;") {
  const l = ["debug", "custom", "info", "warning", "error"];
  l.indexOf(e) >= l.indexOf(t) && console.log(`[${e.toUpperCase()}]:`, a, s)
}

function a(t = "st-licence-KEY", e = "data/bugdata.json", a = "$treetemplate") {
  s("debug", t), async function(t, e = 5e3) {
    const a = Date.now(),
      l = document.querySelector(t);
    if (!l) throw new Error(`Div with selector ${t} does not exist.`);
    for (; Date.now() - a < e;) {
      if ("undefined" != typeof d3) return s("info", "D3.js successfully loaded"), !0;
    ...
    var i = !1;
    null !== document.body.getAttribute("data-jp-theme-name") && (i = !0);
    let d = d3.select("#toolbar-treeID").append("button").html('<svg style="display: inline" xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 8v-2a2 2 0 0 1 2 -2h2" /><path d="M4 16v2a2 2 0 0 0 2 2h2" /><path d="M16 4h2a2 2 0 0 1 2 2v2" /><path d="M16 20h2a2 2 0 0 0 2 -2v-2" /></svg>').attr("class", "st-option-button").attr("id", "openModalBtn-treeID");
    i || d.style("display", "none");
    let c = document.getElementById("myModal-treeID"),
      p = document.getElementById("openModalBtn-treeID"),
      h = document.getElementById("closeBtn-treeID");
    const y = "regression",
      u = "classification",
      f = "nodata";
    let m = !0,
    ...
    const k = 100,
      ...
      E = 195;
    var $ = 0;
    const M = ["#FEFEBB", "#c7e9b4", "#41b6c4", "#FEFECD", "#CFE2D4", "#4575B4", "#313695", "#FEE090", "#006400", "#A6BDDB", "#444443", "#FFFF00", "#00FF00", "#0000FF", "#FFA500", "#800080", "#FF00FF", "#00FFFF", "#FFC0CB", "#808080", "#800000", "#008000", "#000080", "#FFFFE0", "#00FA9A", "#ADD8E6", "#FF4500", "#EE82EE", "#20B2AA", "#778899", "#B22222", "#7FFF00", "#4682B4", "#DAA520", "#4B0082", "#D2691E", "#5F9EA0", "#FF1493", "#696969", "#DC143C", "#00CED1", "#FFD700", "#9932CC", "#8B4513", "#00BFFF", "#FF69B4", "#A9A9A9", "#B22222", "#32CD32", "#1E90FF", "#FF8C00", "#BA55D3", "#8B0000", "#48D1CC", "#DDA0DD", "#FF6347", "#2E8B57", "#6495ED", "#FFA07A", "#9370DB", "#8B008B", "#FF0000", "#bfd2bf", "#a37774", "#124559", "#00FF00", "#46351d", "#0000FF", "#01161e", "#FF00FF", "#FFFF00", "#FF0000", "#93b7be", "#785964", "#00FF00", "#598392", "#eaf0ce", "#0000FF", "#FF00FF", "#FFFF00", "#d75841", "#228B22", "#79625d", "#1E90FF", "#fba64c", "#32CD32", "#a46848", "#4682B4", "#453e2a", "#c8b496", "#00CED1", "#2e1515", "#be9668", "#541e13", "#715a3b", "#17090c", "#dcd1b8", "#3f2926", "#d03c32", "#9e8676", "#e3aa71", "#de5d70", "#544540", "#335f9e", "#ab9682", "#150a2b", "#171559", "#d6d169", "#450c3d", "#913362", "#2b7873", "#2b9e62", "#65aacf", "#1f1718", "#67d95f", "#a61e49", "#f2c6b8", "#e6e3d8", "#eb9494", "#794d81", "#ffd8a9", "#ff5b4f", "#4a3778", "#ffb366", "#ad82cf", "#7e9770", "#f39d91", "#a9548a", "#d38e84", "#8455a9", "#814d6e", "#5d7668", "#f2af92", "#533a44", "#ffffe1", "#9e2081", "#235a63", "#c92e70", "#c37289", "#a83a94", "#db5989", "#4c55ba", "#77c1eb", "#f68484", "#acfff1", "#ffce96", "#512b8c", "#1f4572", "#221330", "#422452", "#d4ffb0", "#50cc9a", "#74ff86", "#201a47", "#2c8a9a", "#000000", "#782b8c", "#fffab2", "#fdffef", "#094d18", "#449481", "#f0cc69", "#df5f36", "#555555", "#497a3a", "#beb866", "#819650", "#7294d6", "#5b2b7c", "#ffffff", "#aaaaaa", "#000000", "#8cdaff", "#f0a34a", "#9f1d2e", "#5b59b3", "#4b0f37", "#63b9bb", "#227944"];
    var z = d3.selectAll("#myModal-treeID").append("div").attr("class", "st-tooltip").style("position", "absolute").style("opacity", 0).style("-webkit-user-select", "none").style("-moz-user-select", "none").style("-ms-user-select", "none").style("font-size", "18px").style("background-color", "rgba(0, 0, 0, 0.7)").style("color", "white").style("padding", "8px").style("border-radius", "4px").style("box-shadow", "0px 4px 8px rgba(0, 0, 0, 0.3)").style("max-width", "200px").style("text-align", "center").style("z-index", "1000").style("transition", "opacity 0.3s ease"),
      I = d3.selectAll("body").append("div").attr("class", "st-tooltip").style("position", "absolute").style("opacity", 0).style("user-select", "none").style("-webkit-user-select", "none").style("-moz-user-select", "none").style("-ms-user-select", "none").style("font-size", "18px").style("background-color", "rgba(0, 0, 0, 0.7)").style("color", "white").style("padding", "8px").style("border-radius", "4px").style("box-shadow", "0px 4px 8px rgba(0, 0, 0, 0.3)").style("max-width", "200px").style("text-align", "center").style("z-index", "1000").style("transition", "opacity 0.3s ease");
    new MutationObserver((function(t, e) {
      if (d3.select(".st-body-tree-div-treeID").empty()) {
        const t = d3.select("#myModal-treeID");
        t.empty() || t.remove(), e.disconnect()
      }
      ...
      try {
        ...
        if ("$treetemplate" != a) {
          var t = a;
          l = {
            nodeData: t.node_data,
            treeData: t.tree_data
          }
        } else {
          const [t] = await Promise.all([fetch(e)]);
          if (!t.ok) throw new Error("Network response was not ok");
          const a = await t.json();
          s("debug", a), l = {
            nodeData: a.node_data,
            treeData: a.tree_data
          }
        }
        return l
      } catch (t) {
        s("error", "Error loading JSON files:")
      }
    }().then((e => {
      if (e) {
        const {
        ...
        function d(t, e) {
          b || null == e.children && null == e._children || (s("debug", " Collapse click event"), b = !0, d3.selectAll("#st-depth-dropdown").attr("disabled", "disabled"), e.children ? (e._children = e.children, e.children = null) : (e.children = e._children, e._children = null), O(e, !1), s("debug", e, "Node w click"), (e.children || e._children) && e.parent ? N(e.parent) : !e.children && !e._children || e.parent || N(), setTimeout((() => {
            b = !1, d3.selectAll("#st-depth-dropdown").attr("disabled", null)
          }), nt))
        }
        0;
        let at = {
          ...
          lt = 2500 - at.left - at.right,
          rt = 1100 - at.top - at.bottom;
        var B = 0;
        const nt = 1250;
        let ot = M.slice(0, 20);
        if (Q.feature_names.length > ot.length) {
          let ht = Q.feature_names.length - ot.length;
          ...
          for (let yt = 0; yt < ht; yt++) ot.push(S())
        }
        var C = d3.zoom().scaleExtent([.05, 5]).on("zoom", (function(t) {
          V.attr("transform", t.transform)
        }));

        function N(e) {
          if (void 0 === e && (e = T, s("debug", "reset", "Reset")), "block" === document.getElementById("myModal-treeID").style.display) {
            var a = (r = document.getElementsByClassName(`st-tree-div-${t}`))[0].clientWidth,
              l = r[0].clientHeight;
            svgElement = d3.select(r[0]).select("svg#mySVG-treeID")
          } else {
            var r;
            a = (r = document.getElementsByClassName("st-body-tree-div-treeID"))[0].clientWidth, l = r[0].clientHeight;
            svgElement = d3.select(r[0]).select("svg#mySVG-treeID")
          }
          let n = 1;
          n = lt < a && rt < l ? 1 : Math.min(a / lt, l / rt), s("debug", rt, "H"), s("debug", lt, "W"), n = Math.max(.05, n);
          let o = d3.zoomIdentity.translate(-e.x * n + a / 2, 100).scale(n);
          svgElement.transition().duration(nt).call(C.transform, o)
        }
        h.onclick = function() {
          c.style.display = "none", N()
        }, window.onclick = function(t) {
          t.target == c && (c.style.display = "none", N())
        }, p.onclick = function() {
          c.style.display = "block", N()
        };
        var T = d3.hierarchy(et);
        T.x0 = 0, T.y0 = lt / 2;
        var X = 0,
          Y = 0;
        ! function t(e) {
          X = Math.max(X, e.depth), e.children ? e.children.forEach((function(e) {
            t(e)
          })) : Y++
        ...
        function O(t, e) {
          ...
          d3.selectAll("#st-link-treeID").style("stroke", "black"), minSample = 1 / 0, Y = 0, X = 0,
            ...
            }(T, 0), lt = 300 * Y, rt = 400 * X;
          let p = d3.tree().size([lt, rt])(T);
          s("debug", p, "TreeLayout");
          let h = p.descendants(),
            b = p.descendants().slice(1);
          h.forEach((function(t) {
            t.y = 180 * t.depth, t.hasOwnProperty("cx") || (t.cx = 1 * t.x), t.hasOwnProperty("cy") || (t.cy = 1 * t.y)
          })), h.forEach((function(t) {
            t.y0 = t.y, t.x0 = t.x
          }));
          var M = V.selectAll(".treeNode").data(T.descendants(), (function(t) {
            return t.id || (t.id = ++B)
          }));

          function S(t, e = []) {
            return t._children && t._children.forEach((function(t) {
              e.push(t), S(t, e)
          ...
          var C = M.enter().append("g").attr("class", "treeNode").attr("transform", (e => "translate(" + t.cx + "," + t.cy + ")")).on("click", d);
          a = Array.from({
            length: st
          }, (() => [1 / 0, -1 / 0])), i = Array.from({
            length: st
          }, (() => [0, -1 / 0]));
          for (let t = 0; t < st; t++) {
            let e = [];
            for (let s = 0; s < Q.data_feature.length; s++) e.push(Q.data_feature[s][t]);
            let s = d3.extent(e);
            a[t][0] = Math.min(a[t][0], s[0]), a[t][1] = Math.max(a[t][1], s[1])
          }
          for (let t = 0; t < st; t++) a[t][0] -= .2, a[t][1] += .2;
          Q.tree_type == y && (C.each((function(t) {
            n.call(this, t, Q, A, 80, _, F, E, D, I, z, ot)
          })), C.each((function(t) {
            o.call(this, t, Q, 90, 80, D, I, z, d, R)
          }))), Q.tree_type == u && (C.each((function(t) {
            l.call(this, Q, I, z, x, a, g, i, d, _, F, E, D, ot, t)
          })), C.each((function(t) {
            if (t.data.is_leaf) {
              var e = 0;
              for (let s = 0; s < t.data.class_distribution[0].length; s++) e += parseFloat(t.data.class_distribution[0][s]);
              $ = Math.max($, e), minSample = Math.min(minSample, e)
            }
          })), $ > 0 && (v = Math.max($, v)), C.each((function(t) {
            r.call(this, Q, w, k, E, D, A, 80, ot, $, R, d3, I, z, t)
          }))), Q.tree_type.startsWith(f) && C.each((function(t) {
            t.data.is_leaf || (
            d3.select(this)
              .append("rect")
            ...
            d3.select(this)
              ...
              .text((t => "Threshold " + parseFloat(t.data.threshold)
              .toFixed(3)))
            ...
            d3.select(this)
              ...
              .attr("class", "st-target")
              .style("text-anchor", "middle")
              .text((t => "Impurity: " + t.data.impurity))
              .style("-webkit-user-select", "none")
              .style("-moz-user-select", "none")
              .style("-ms-user-select", "none"),
            d3.select(this)
            ...
            d3.select(this)
              ...
              .attr("class", "st-target")
              .style("text-anchor", "middle")
              .text((t => "Value [" + t.data.class_distribution + "]"))
              .style("-webkit-user-select", "none")
              .style("-moz-user-select", "none")
              .style("-ms-user-select", "none"),
            d3.select(this)
          ...
          })), C.merge(M).transition().duration(nt).tween("logging", (function(e) {
            let s = d3.interpolate(1 * t.x0, 1 * e.x),
              a = d3.interpolate(1 * t.y, 1 * e.y);
            return function(t) {
              let l = s(t),
                r = a(t);
              e.cx = l, e.cy = r
            ...
            return "translate(" + 1 * t.x + "," + 1 * t.y + ")"
          }));
          let N = [];
          N = S(t);
          let j = new Set(N.map((t => t.id))),
            L = M.exit().filter((function(t) {
              return j.has(t.id)
          ...
          L.selectAll("circle")
            ...
            .attr("cx", -55)
            .attr("cy", 0),
          L.selectAll("path.piechart")
            .attr("transform", "translate(-97.5,0)")
            .attr("d", d3.arc()
            .innerRadius(0)
            .outerRadius(1));

          let H = L.select(".st-grid");

          L.selectAll("line.threshold-line")
          ...
          P.exit().filter((function(t) {
            return j.has(t.id)
          })).transition().duration(nt).attr("d", (function(e) {
            var s = {
              x: t.x,
              y: t.y0
            };
        ...
        const it = function(t) {
          ...
          dt = function(t) {
            I.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), z.style("opacity", 0).style("top", "-2000px").style("left", "-2000px")
          },
          ct = function(t, e) {
            I.html(`<b>${e}</b>`).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px"), z.html(`<b>${e}</b>`).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px")
          };
        d3.select("#openModalBtn-treeID").on("mouseover", it).on("mouseleave", dt).on("mousemove", (function(t) {
          ct(event, "Open modal window")
        }));
        d3.selectAll("#toolbar-treeID").append("button").html('<svg style="display: inline"  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-2" /><path d="M7 11l5 5l5 -5" /><path d="M12 4l0 12" /></svg>').attr("id", "svgButton").attr("class", "st-option-button").on("click", (function() {
          var t = document.getElementById("mySVG-treeID"),
            e = (new XMLSerializer).serializeToString(t),
            s = new Blob([e], {
              type: "image/svg+xml;charset=utf-8"
            }),
            a = document.createElement("a");
          a.href = URL.createObjectURL(s), a.download = "myDiagram.svg", document.body.appendChild(a), a.click(), document.body.removeChild(a)
        })).on("mouseover", it).on("mouseleave", dt).on("mousemove", (function(t) {
          ct(event, "Save SVG")
        }));
        if (void 0 !== Q.show_sample && "nodata" != Q.show_sample && !Q.tree_type.startsWith("nodata")) d3.selectAll("#toolbar-treeID").append("button").html('<svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-test-pipe-2"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 3v15a3 3 0 0 1 -6 0v-15" /><path d="M9 12h6" /><path d="M8 3h8" /></svg>').attr("id", "showSampleButton").attr("class", "st-option-button").on("click", (function() {
          var t = null;

          function e(s) {
            if (s.children) s.children.forEach((function(t) {
              e(t)
            }));
            else if (s._children) s._children.forEach((function(t) {
              e(t)
            }));
            else {
              var a = !0;
              s.data.start_end_x_axis.forEach(((t, e) => {
                const s = Q.show_sample[e];
                "notexist" != t[0] && s > t[0] && (a = !1), "notexist" != t[1] && s < t[1] && (a = !1)
              })), a && (t = s)
            }
          }
          if (e(T), s("debug", t, "SampleNode"), b) return;
          b = !0, d3.selectAll("#st-depth-dropdown").attr("disabled", "disabled"), G(T, 0, t.depth + 1, !0), H.forEach((function(t) {
            O(t, !1)
          })), P.property("value", W[t.depth]), setTimeout((() => {
            b = !1, d3.selectAll("#st-depth-dropdown").attr("disabled", null)
          }), nt), H = [], N(), R(t)
        })).on("mouseover", it).on("mouseleave", dt).on("mousemove", (function(t) {
          ct(event, "Show sample path")
        }));
        ...
        function R(t) {
          d3.selectAll("#st-link-treeID").style("stroke", "black"), pathData = function(t) {
            ...
            function l(t) {
              s("debug", t, "Node w dfsie"), e.push(t.id), a.push(t), t.parent && l(t.parent)
            }
            return l(t), {
              ids: e,
              nodedata: a
          ...
          a.classed("show") ? (a.classed("show", !1).classed("hide", !0), setTimeout((function() {
            j.selectAll("g").remove(), a.classed("hide", !1).classed("show", !0), q(nodedata)
          }), 300)) : (a.classed("hide", !1).classed("show", !0), q(nodedata))
        }

        function q(t) {
          t.slice().reverse().forEach((function(t, e) {
            let s = 150,
              c = 200 * e + 100;
            Q.tree_type == y && t.data.is_leaf && (s -= 10);
            j.append("g").attr("class", "node-group").attr("transform", `translate(${s}, ${c})`).datum(t).each((function(e) {
              Q.tree_type == u && (t.data.is_leaf || l.call(this, Q, I, z, x, a, g, i, d, _, F, E, D, ot, t), t.data.is_leaf && r.call(this, Q, w, k, E, D, A, 80, ot, v, R, d3, I, z, e)), Q.tree_type == y && (t.data.is_leaf || n.call(this, e, Q, A, 80, _, F, E, D, I, z, ot), t.data.is_leaf && o.call(this, e, Q, 90, 80, D, I, z, d, R))
            }))
          }))
        }
        ...
        var H = [],
          P = pt.append("select").attr("id", "st-depth-dropdown").attr("class", "st-dropdown").on("change", (function(t, e = "optional") {
            var s = 0;
            s = "optional" !== e ? e : Z(this.value) + 1;
            if (null != s) {
              if (b) return;
              b = !0, d3.selectAll("#st-depth-dropdown").attr("disabled", "disabled"), G(T, 0, s, !0), H.forEach((function(t) {
                O(t, !1)
              })), P.property("value", W[s - 1]), setTimeout((() => {
                b = !1, d3.selectAll("#st-depth-dropdown").attr("disabled", null)
              }), nt), H = [], N()
            }
          }));
        ...
        function G(t, e, s, a) {
          ...
          } else e > s ? (t.children && (t._children = t.children, t.children = null), t._children && t._children.forEach((function(t) {
            G(t, e, s, a)
          }))) : e == s && (t.children && (t._children = t.children, t.children = null), t._children && t._children.forEach((function(t) {
            G(t, e, s, a)
          })), 1 == a && H.push(t))
        }
        setTimeout((function() {
        ...
        var W = [];
        for (let xt = 1; xt <= U; xt++) W.push("Depth = " + (xt - 1));

        function K(t, e, s) {
          e++, t.children && e == s ? (t._children = t.children, t.children = null) : t.children && t.children.forEach((function(t) {
            G(t, e, s)
          }))
        }
...
function l(t, a, l, r, n, o, i, d, c, p, h, y, u, f) {
  var m = !1;
  if (!f.data.is_leaf) {
    "nodata" != t.show_sample && null != t.show_sample && (m = !0);
    var x = !0;
    x = !!m;
    const _ = f.data.feature,
      F = [...new Set(t.data_target)],
      A = Math.max(...F);
    let D = Array.from({
      length: A + 1
    }, (() => []));
    s("debug", D, "filtered"), s("debug", t.data_target, "data_target"), t.data_feature.forEach(((e, s) => {
      const a = t.data_target[s];
      D[a].push(e)
    }));
    var g = [1 / 0, -1 / 0];
    f.data.start_end_x_axis.forEach(((t, e) => {
      "notexist" != t[0] && D.forEach(((s, a) => {
        D[a] = s.filter((s => s[e] < t[0]))
      })), "notexist" != t[1] && D.forEach(((s, a) => {
        D[a] = s.filter((s => s[e] > t[1]))
      }))
    })), m && f.data.start_end_x_axis.forEach(((e, s) => {
      const a = t.show_sample[s];
      "notexist" != e[0] && a > e[0] && (x = !1), "notexist" != e[1] && a < e[1] && (x = !1)
    }));
    let E = D.map((t => t.map((t => t[_]))));
    const $ = [];
    let M = Array.from({
    ...
    E = E.map(((t, e) => {
      ...
      return 0 === s.length && $.push(e), s
    })).filter((t => t.length > 0));
    let z = new Set($);
    M = M.filter((t => !z.has(t))), E.map((t => {
      // TODO: here-ish?
      var e = d3.extent(t);
      g[0] = Math.min(g[0], e[0]), g[1] = Math.max(g[1], e[1])
    })), g[0] = g[0] - .2, g[1] = g[1] + .2, r && (g = n[_]), g[0] > f.data.threshold && (g[0] = f.data.threshold - .2), g[1] < f.data.threshold && (g[1] = f.data.threshold + .2), x && (g[0] > t.show_sample[_] && (g[0] = t.show_sample[_] - .2), g[1] < t.show_sample[_] && (g[1] = t.show_sample[_] + .2));
    const I = d3.scaleLinear().domain(g).range([0, c]);
    ...
    const B = function(t, e) {
      s("debug", e, "mousemoveAllData"),
      a.html(`<b>All Data</b>:<br>Class distribution: ${e.data.class_distribution}\n        <br>Impurity: ${e.data.impurity}\n        <br>Samples: ${e.data.samples}\n        <br>Threshold: ${parseFloat(e.data.threshold).toFixed(3)}\n        <br>Treeclass: ${e.data.treeclass}`)
       .style("top", t.pageY - 10 + "px")
       .style("left", t.pageX + 10 + "px")
       .style("opacity", 1),
      l.html(`<b>All Data</b>:<br>Class distribution: ${e.data.class_distribution}\n        <br>Impurity: ${e.data.impurity}\n        <br>Samples: ${e.data.samples}\n        <br>Threshold: ${parseFloat(e.data.threshold).toFixed(3)}\n        <br>Treeclass: ${e.data.treeclass}`)
       .style("top", t.pageY - 10 + "px")
       .style("left", t.pageX + 10 + "px")
       .style("opacity", 1)
    },
    ...
    const T = d3.scaleLinear().range([p, 0]),
      ...
      Y = d3.bin().domain(I.domain()).thresholds(I.ticks(20)),
      V = E.map((t => Y(t)));

    s("debug", V, "binsData");

    const j = d3.stack().keys(d3.range(E.length)).value(((t, e) => t[e] ? t[e].length : 0))(d3.transpose(V));

    var b = [0, 0];

    b[0] = 0,
    b[1] = d3.max(j, (t => d3.max(t, (t => t[1])))),
    i[_][1] = Math.max(i[_][1], d3.max(j, (t => d3.max(t, (t => t[1]))))),
    o && (b = i[_]),
    T.domain(b);

    const L = T.domain(),
      O = [L[0], L[0] + (L[1] - L[0]) / 2, L[1]];

    s("debug", O, "YTICKVALUES"),
    O.every((t => !isNaN(t))) && X.call(
      d3.axisRight(T)
        .tickSize(0)
        .tickPadding(4)
        .tickValues(O)
    ...
    H = function(e, s) {
      a.html(`<b>${t.target_names[s.class]}</b>: ${s[1]-s[0]}`)
       .style("top", e.pageY - 10 + "px")
       .style("left", e.pageX + 10 + "px"),
      l.html(`<b>${t.target_names[s.class]}</b>: ${s[1]-s[0]}`)
       .style("top", e.pageY - 10 + "px")
       .style("left", e.pageX + 10 + "px")
    };
...
function r(t, e, a, l, r, n, o, i, d, c, p, h, y, u) {
  var f = p.format(",.0f");
  if (u.data.is_leaf) {
    u.data.feature;
    "nodata" != t.show_sample && (s("debug", t.show_sample, "treedatasample"), x = !0);
    var m = !0;
    m = !!x;
    const o = u.data.class_distribution[0],
      b = [],
      v = o.map(((e, s) => ({
        target_name: `${t.target_names[s]}`,
        classDistributionValue: e,
        index: s
      }))).filter((t => 0 !== t.classDistributionValue || (b.push(t.index), !1))).map((t => ({
        target_name: t.target_name,
        classDistributionValue: t.classDistributionValue
      })));
    var x = !1;
    "nodata" != t.show_sample && void 0 !== t.show_sample && (s("debug", t.show_sample, "treedatasample"), x = !0);
    m = !0;
    m = !!x;
    let k = Array.from({
        length: o.length
      ...
      w = new Set(b);
    k = k.filter((t => !w.has(t))), m && u.data.start_end_x_axis.forEach(((e, s) => {
      const a = t.show_sample[s];
      "notexist" != e[0] && a > e[0] && (m = !1), "notexist" != e[1] && a < e[1] && (m = !1)
    }));
    var g = 0;
    for (let t = 0; t < u.data.class_distribution[0].length; t++) g += parseInt(u.data.class_distribution[0][t]);
    const _ = Math.max(20, Math.min(e, a) / 2 * Math.sqrt(g / d));
    s("debug", g, "current sample"), s("debug", d, "max sample");
    const F = p.pie().value((t => t.classDistributionValue)).sort(null),
      A = F(v),
      D = p.arc().innerRadius(0).outerRadius(_);
    s("debug", "treeID", "tree id"), s("debug", _, "srednicaaaaaaaa"), s("debug", g, "current samples"), s("debug", d, "max sample"), v.forEach((function(t) {
      t.classDistributionValue = +t.classDistributionValue, t.enabled = !0
    }));
    p.sum(v.map((function(t) {
      return t.enabled ? t.classDistributionValue : 0
    })));
    const E = function(t) {
        h.style("opacity", 1), y.style("opacity", 1), p.select(this).style("stroke", "#EF4A60")
      },
      $ = function(t) {
        h.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), y.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), p.select(this).style("stroke", "black")
      },
      M = function(t, e) {
        h.html(`<b>${e.data.target_name}</b>: ${e.data.classDistributionValue}`).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px"), y.html(`<b>${e.data.target_name}</b>: ${e.data.classDistributionValue}`).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px")
      };
    if (A[0] && "data" in A[0]) {
...
function n(t, a, l, r, n, o, i, d, c, p, h) {
  if (!t.data.is_leaf) {
    const h = t.data.feature;
    let g = a.data_feature.map((e => e[t.data.feature])).map(((t, e) => [t, a.data_target[e]])),
      b = new Set;
    t.data.start_end_x_axis.forEach(((t, e) => {
      "notexist" != t[0] && a.data_feature.forEach(((s, a) => {
        s[e] > t[0] && b.add(a)
      })), "notexist" != t[1] && a.data_feature.forEach(((s, a) => {
        s[e] < t[1] && b.add(a)
      }))
    }));
    var y = !1;
    "nodata" != a.show_sample && null != a.show_sample && (s("debug", a.show_sample, "treedatasample"), y = !0);
    var u = !0;
    u = !!y, y && t.data.start_end_x_axis.forEach(((t, e) => {
      const s = a.show_sample[e];
      "notexist" != t[0] && s > t[0] && (u = !1), "notexist" != t[1] && s < t[1] && (u = !1)
    }));
    let v = Array.from(new Set([...b]));
    v.sort(((t, e) => e - t)), v.forEach((t => {
      t >= 0 && t < g.length && g.splice(t, 1)
    ...
    const w = function(t, e) {
      let s = 0,
        ...
        r = 0;
      return t.forEach((t => {
        t[0] < e ? (s += t[1], a++) : (l += t[1], r++)
      })), {
        averageBelowThreshold: s / a,
        averageAboveOrEqualThreshold: l / r
      }
    }(g, t.data.threshold);
    xExtent = d3.extent(k), (NaN === xExtent[0] || void 0 === xExtent[0] || xExtent[0] > t.data.threshold) && (xExtent[0] = t.data.threshold - .2), (NaN === xExtent[1] || void 0 === xExtent[1] || xExtent[1] < t.data.threshold) && (xExtent[1] = t.data.threshold + .2), u && (xExtent[0] > a.show_sample[h] && (xExtent[0] = a.show_sample[h] - .2), xExtent[1] < a.show_sample[h] && (xExtent[1] = a.show_sample[h] + .2));
    ...
    const M = function(t) {
      ...
      z = function(t) {
        c.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), d3.select(this).style("fill", "blue"), p.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), d3.select(this).style("fill", "blue")
      },
      I = function(t) {
        c.style("opacity", 1), d3.select(this).style("stroke", "red"), p.style("opacity", 1), d3.select(this).style("stroke", "red")
      },
      B = function(t) {
        c.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), d3.select(this).style("stroke", "black"), p.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), d3.select(this).style("stroke", "black")
      },
      S = function(t, e) {
        c.html(`<b>(X,Y):</b> (${parseFloat(e[0]).toFixed(3)}) (${parseFloat(e[1]).toFixed(3)})`).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px"), p.html(`<b>(X,Y):</b> (${parseFloat(e[0]).toFixed(3)}) (${parseFloat(e[1]).toFixed(3)})`).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px")
      };
    d3.select(this).append("g").selectAll("g").data(g).join("circle").attr("cx", ((t, e) => _(g[e][0]))).attr("cy", ((t, e) => D(g[e][1]))).attr("r", 2).attr("transform", `translate(${-l/2}, 0)`).style("fill", "blue").style("fill-opacity", .5).on("mouseover", M).on("mouseleave", z).on("mousemove", S);
    const C = function(t, e) {
        c.html(`<b>Average:</b> ${parseFloat(w.averageBelowThreshold).toFixed(3)} `).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px"), p.html(`<b>Average:</b> ${parseFloat(w.averageBelowThreshold).toFixed(3)} `).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px")
      },
      N = function(t, e) {
        c.html(`<b>Average:</b> ${parseFloat(w.averageAboveOrEqualThreshold).toFixed(3)} `).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px"), p.html(`<b>Averge:</b> ${parseFloat(w.averageAboveOrEqualThreshold).toFixed(3)} `).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px")
      },
      T = function(t, e) {
        c.html(`<b>All Data</b>\n        <br>Impurity: ${e.data.impurity}\n        <br>Samples: ${e.data.samples}\n        <br>Threshold: ${parseFloat(e.data.threshold).toFixed(3)}`).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px").style("opacity", 1), p.html(`<b>All Data</b>:<br>\n        <br>Impurity: ${e.data.impurity}\n        <br>Samples: ${e.data.samples}\n        <br>Threshold: ${parseFloat(e.data.threshold).toFixed(3)}`).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px").style("opacity", 1)
      },
      X = function(t, e) {
    ...
    u && (s("debug", t, "Exist"), d3.select(this).append("path").attr("d", x).attr("class", "st-triangle").style("stroke-width", 1).style("stroke-opacity", 1).style("fill", "green").attr("transform", (function(t) {
      return "translate(" + (-n / 2 + _(a.show_sample[h])) + "," + m + ")"
    })).on("mouseover", (function(t) {
      c.style("opacity", 1), p.style("opacity", 1), d3.select(this).style("fill", "red").style("stroke", "red")
    })).on("mouseleave", (function(t) {
      c.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), p.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), d3.select(this).style("fill", "green").style("stroke", "green")
    })).on("mousemove", (function(t, e) {
      p.html(a.feature_names.map(((t, e) => {
        const s = a.show_sample[e];
        return `<b>${t}:</b> ${isNaN(parseFloat(s))?"N/A":parseFloat(s).toFixed(3)}`
      })).join(",")).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px"), c.html(a.feature_names.map(((t, e) => {
        const s = a.show_sample[e];
        return `<b>${t}:</b> ${isNaN(parseFloat(s))?"N/A":parseFloat(s).toFixed(3)}`
      })).join(",")).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px")
    })))
  }
}

function o(t, a, l, r, n, o, i, d, c) {
  if (t.data.is_leaf) {
    const g = t.data.feature;
    var p = !1;
    "nodata" != a.show_sample && void 0 !== a.show_sample && (p = !0);
    var h = p;
    let b = a.data_feature.map((e => e[t.parent.data.feature])).map(((t, e) => [t, a.data_target[e]])),
      v = new Set;
    t.data.start_end_x_axis.forEach(((t, e) => {
      "notexist" != t[0] && a.data_feature.forEach(((s, a) => {
        s[e] > t[0] && v.add(a)
    ...
    let k = Array.from(new Set([...v]));
    k.sort(((t, e) => e - t)), k.forEach((t => {
      t >= 0 && t < b.length && b.splice(t, 1)
    })), p && t.data.start_end_x_axis.forEach(((t, e) => {
      const s = a.show_sample[e];
      "notexist" != t[0] && s > t[0] && (h = !1), "notexist" != t[1] && s < t[1] && (h = !1)
    }));
    var y = t;
    ...
    d3.select(this)
      ...
      .attr("width", n + 20)
      .attr("height", n - 10)
      .attr("stroke-width", h ? 4 : 1)
      .attr("stroke", "#545454")
      .attr("rx", 10)
      .attr("ry", 10)
      .style("fill", "#ffffff")
      .on("click", d)
      .on("click", (function() { c(y) }));

    let w = b.map((t => t[0]));
    const _ = function(t) {
      const e = t.length;
      return t.reduce(((t, e) => t + e[1]), 0) / e
    }(b);
    var u = d3.extent(w);
    u[0] = u[0] - .2, u[1] = u[1] + .2, h && (u[0] > a.show_sample[g] && (u[0] = a.show_sample[g] - .2), u[1] < a.show_sample[g] && (u[1] = a.show_sample[g] + .2));
    const F = d3.scaleLinear().domain(u).nice().range([0, l]);
    yExtent = d3.extent(a.data_target);
    ...
    const $ = function(t) {
      ...
      M = function(t) {
        o.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), d3.select(this).style("fill", "blue"), i.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), d3.select(this).style("fill", "blue")
      },
      z = function(t) {
        o.style("opacity", 1), d3.select(this).style("stroke", "red"), i.style("opacity", 1), d3.select(this).style("stroke", "red")
      },
      I = function(t) {
        o.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), d3.select(this).style("stroke", "black"), i.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), d3.select(this).style("stroke", "black")
      },
      B = function(t, e) {
        o.html(`<b>(X,Y):</b> (${parseFloat(e[0]).toFixed(3)}) (${parseFloat(e[1]).toFixed(3)})`).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px"), i.html(`<b>(X,Y):</b> (${parseFloat(e[0]).toFixed(3)}) (${parseFloat(e[1]).toFixed(3)})`).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px")
      },
      S = function(t, e) {
        o.html(`<b>Average:</b> ${parseFloat(_).toFixed(3)} `).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px"), i.html(`<b>Average:</b> ${parseFloat(_).toFixed(3)} `).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px")
      };
    d3.select(this).append("g").selectAll("g").data(b).join("circle").attr("cx", ((t, e) => F(b[e][0]))).attr("cy", ((t, e) => A(b[e][1]))).attr("r", 2).attr("transform", `translate(${-l/2+15}, 0)`).style("fill", "blue").style("fill-opacity", .5).on("mouseover", $).on("mouseleave", M).on("mousemove", B), isNaN(_) || d3.select(this).append("line").attr("class", "average-line").attr("x1", 0).attr("x2", l).attr("y1", A(_)).attr("y2", A(_)).attr("stroke", "black").attr("transform", `translate(${-l/2+15},0)`).attr("stroke-width", 2).attr("stroke-dasharray", "5,5").on("mouseover", z).on("mouseleave", I).on("mousemove", S);
    var f = n + 1.1 * d3.select(this).append("text").attr("class", "st-target").attr("x", 15).attr("y", n + 5).style("text-anchor", "middle").style("font-size", "18px").text(`${t.data.treeclass} = ${parseFloat(t.data.class_distribution[0][0].toFixed(3))}`).style("user-select", "none").style("-webkit-user-select", "none").style("-moz-user-select", "none").style("-ms-user-select", "none").call((function(t, e) {
      t.each((function() {
        for (var t, s = d3.select(this), a = s.text().split(/\s+/).reverse(), l = [], r = 0, n = s.attr("x"), o = s.attr("y"), i = s.text(null).append("tspan").attr("x", n).attr("y", o); t = a.pop();) l.push(t), i.text(l.join(" ")), i.node().getComputedTextLength() > e && l.length > 1 && (l.pop(), i.text(l.join(" ")), l = [t], i = s.append("tspan").attr("class", "st-target").attr("x", n).attr("y", o).attr("dy", 1.1 * ++r + "em").text(t))
      }))
    }), 100).selectAll("tspan").size() * 18 + 5;
    d3.select(this).append("text").attr("class", "st-target").attr("x", 15).attr("y", f).style("text-anchor", "middle").style("font-size", "18px").text(`n = ${t.data.samples}`).style("user-select", "none").style("-webkit-user-select", "none").style("-moz-user-select", "none").style("-ms-user-select", "none");
    var m = "green",
      x = d3.symbol().type(d3.symbolTriangle).size(25);
    s("debug", t, "XSCALE"), h && (s("debug", t, "Existtt"), d3.select(this).append("path").attr("d", x).attr("class", "st-triangle").style("stroke", m).style("stroke-width", 1).style("stroke-opacity", 1).style("fill", m).attr("transform", (function(t) {
      return "translate(" + (-l / 2 + 15 + F(a.show_sample[t.parent.data.feature])) + "," + r + ")"
    })).on("mouseover", (function(t) {
      o.style("opacity", 1), i.style("opacity", 1), d3.select(this).style("fill", "red").style("stroke", "red")
    })).on("mouseleave", (function(t) {
      o.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), i.style("opacity", 0).style("top", "-2000px").style("left", "-2000px"), d3.select(this).style("fill", "green").style("stroke", "green")
    })).on("mousemove", (function(t, e) {
      i.html(a.feature_names.map(((t, e) => {
        const s = a.show_sample[e];
        return `<b>${t}:</b> ${isNaN(parseFloat(s))?"N/A":parseFloat(s).toFixed(3)}`
      })).join(",")).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px"), o.html(a.feature_names.map(((t, e) => {
        const s = a.show_sample[e];
        return `<b>${t}:</b> ${isNaN(parseFloat(s))?"N/A":parseFloat(s).toFixed(3)}`
      })).join(",")).style("top", t.pageY - 10 + "px").style("left", t.pageX + 10 + "px")
    })))
